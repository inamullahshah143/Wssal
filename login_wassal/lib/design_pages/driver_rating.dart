                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text("Good Service"),
                                Checkbox(
                                    activeColor: Color.fromRGBO(222, 53, 11, 1),
                                    value: isChecked,
                                    onChanged: (value) {
                                      setState(() {
                                        isChecked = value;
