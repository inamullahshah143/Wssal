...
class Subcategory extends StatefulWidget {
  ...
  int index;
  @override
  _SubcategoryState createState() => _SubcategoryState(subcatBlock: subcatBlock);
}
...
class _SubcategoryState extends State<Subcategory> {
  ...
  var response = await http.get(Uri.parse("$apiURL/subcategoryProducts/${subcatBlock['id']}"));
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ProductDetails(d: element)),
                        );
                      },
                      child: Container(
                        height: 120,
