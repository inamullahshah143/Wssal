...
class UpdateShop extends StatefulWidget {
  final Map shopData;
  UpdateShop(this.shopData);

  @override
  _UpdateShopState createState() => _UpdateShopState(shopData);
}

class _UpdateShopState extends State<UpdateShop> {
  final Map shopData;
  _UpdateShopState(this.shopData);
  // List<File> multifile = [];
  File file;
  var logo;
  var len;
    ...
    Timer(Duration(seconds: 1), () async {
      try {
        ...
        var response = await dio.post(
            "https://wassl.einnovention.tech/api/vendor/shop/$shopId",
            data: formData);
