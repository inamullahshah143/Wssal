...
class UpdateVariants extends StatefulWidget {
  final Map variantsData;
  UpdateVariants(this.variantsData);

  @override
  _UpdateVariantsState createState() => _UpdateVariantsState(variantsData);
}

class _UpdateVariantsState extends State<UpdateVariants> {
  final variantsData;
  _UpdateVariantsState(this.variantsData);
  ...
  updatevariantss() async {
    try {
      ...
      if (data['message'] == 'Record Successfully Updated!') {
        showAlert(
          context: context,
          title: "Variants Successfully Updated",
          actions: [
            AlertAction(
                text: "Ok ",
                isDestructiveAction: true,
